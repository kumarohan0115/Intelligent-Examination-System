    ...
    <div class="container">
        ...
        <div class="main">
                    ...
                    <ul id="paperName">
                        ...
                        ?>
                                    <li class="paperNameforUpdate" id='lists'>
                                        ...
                                        <button class=" btn btn-primary" onclick="sendData(this)">Update</button>
                                    </li>
                        <?php
                                }
                            }
                        ...
                        <script>
                            function sendData(btn) {
                                ...
                                let subjectSpan = btn.parentElement.querySelector('.subject_name');
                                let cvalue = subjectSpan.innerHTML.trim();
            ...
            <div class="examRecords" id='examRecords'>
                <form id="examRecordForm" class="form-group">

                    <h2>Exam Record</h2>

                    <select name="subject" id="examSubjectSelect" class="form-control" style="padding:.8rem">
                        <option value="Select" selected>Select</option>
                        <?php
                        $dbconnection;
                    ...
                    <div class="button-sub">
                        <button type="button" id="showRecordBtn" class="btn btn-lg btn-success">SHOW</button>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // AJAX handler for showing exam records
        $("#showRecordBtn").click(function() {
            var subject = $("#examSubjectSelect").val();
            if (subject === "Select") {
            ...
            $.ajax({
                type: 'POST',
                url: 'getExamRecord.php',
                data: {
                    subject: subject
                },
                success: function(response) {
                    $("#examRecordTable").html(response);
                },
                error: function() {
