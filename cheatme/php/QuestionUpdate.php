...
if (isset($_COOKIE["subjectName"]) && !empty(trim($_COOKIE["subjectName"]))) {
    $subject = trim($_COOKIE["subjectName"]);
} else {
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="80.604" height="50.099" viewBox="0 0 107.604 66.099">
                        <g id="Group_2" data-name="Group 2" transform="translate(-60.482 -170.341)">
                            <path id="Path_197" data-name="Path 197"
                                d="M29.207,55.339V7.686L1.537,0,21.816,3.191,15.792,0H45.347V66.1H15.792l6.023-3.226L0,66.1ZM52.265,0H76.091a43.551,43.551,0,0,1,12.3,1.537c4.612.769,7.686,3.074,10.76,6.149s4.612,6.149,6.149,10.76A46.22,46.22,0,0,1,107.6,33.818,37.233,37.233,0,0,1,105.3,47.653a28.942,28.942,0,0,1-6.917,11.529c-2.306,2.306-5.38,3.843-9.223,5.38A46.519,46.519,0,0,1,77.628,66.1H52.265Zm0,0V66.1l23.058-10.76c3.843,0,6.149,0,7.686-.769a12.388,12.388,0,0,0,5.38-3.074c1.537-1.537,2.306-3.074,3.843-6.149s1.537-6.917,1.537-12.3a37.444,37.444,0,0,0-1.537-11.529,16.736,16.736,0,0,0-3.843-6.149c-1.537-1.537-3.843-2.306-6.149-3.074-1.537-.769-5.38-.769-10.76-.769L52.265,0Z"
                                transform="translate(168.086 236.44) rotate(180)" fill="#fff" />
                        </g>
                    </svg>
                </a>
            </li>
                ...
                <span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30"
                        ...
                        <g id="Backward_arrow" data-name="Backward arrow" clip-path="url(#clip-path)">
                            <path id="Path_10" data-name="Path 10"
                                ...
                                transform="translate(16 16) rotate(180)" fill="#fff" />
                        </g>
                    </svg>
                </span>
            </a>
            ...
            if (mysqli_num_rows($mysqlFor_query) > 0 && mysqli_num_rows($mysqli_Foranswer) > 0) {
                while (($rowdetails = mysqli_fetch_assoc($mysqlFor_query)) && ($rowForAnswer = mysqli_fetch_assoc($mysqli_Foranswer))) {
                    ...
                    <div class="Question form-group">
                        ...
                        <textarea class="form-control questionInput" name="question[<?php echo $counter ?>]"
                            style="border: 2px solid black;margin-top: 50px;" id="question_s"
                            placeholder="Insert Question Here..."><?php echo $rowdetails['question'] ?></textarea>
                        <ul>
                            <label for="options">Options</label>
                            <li><input class="form-control eventinput" type="text" name="option1[<?php echo $counter ?>]"
                                    id="option__1" value=<?php echo $rowdetails['option1'] ?> placeholder="Option-1"></li>
                            <br>
                            <li><input class="form-control eventinput" type="text" name="option2[<?php echo $counter ?>]"
                                    id="option__2" value=<?php echo $rowdetails['option2'] ?> placeholder="Option-2"></li>
                            <br>
                            <li><input class="form-control eventinput" type="text" name="option3[<?php echo $counter ?>]"
                                    id="option__3" value=<?php echo $rowdetails['option3'] ?> placeholder="Option-3"></li>
                            <br>
                            <li><input class="form-control eventinput" type="text" name="option4[<?php echo $counter ?>]"
                                    id="option__4" value=<?php echo $rowdetails['option4'] ?> placeholder="Option-4"></li>
                            <label for="Answer">Answer</label>
                            <li><input class="form-control ans_data" type="text" name="answer[<?php echo $counter ?>]"
                                    id="answer_s" value=<?php echo $rowForAnswer['answer'] ?> placeholder="Correct Answer"></li>
                        </ul>
                    </div>
                    <div class="warn">
                    ...
                    <div class="actionButton">
                        <button type="button" name="submit" class="btn btn-lg btn-primary"
                            onclick='saveChanges(<?php echo $counter ?>)'>Save Changes</button>
                    </div>
            <?php
...
<script>
    function saveChanges(counter) {
        $.ajax({
            ...
            success: function(){
                location.href='../php/testManagmentBoard.php';
            }
        });
    }
</script>